...
export default function SupportTickets() {
  ...
  const fetchTickets = async () => {
    ...
    try {
      ...
      const res = await fetch('https://unbwnd-backned1.onrender.com/api/admin/tickets');
      if (res.ok) {
  ...
  const handleReplySubmit = async (ticketId) => {
    ...
    try {
      const res = await fetch(`https://unbwnd-backned1.onrender.com/api/admin/tickets/${ticketId}/reply`, {
        method: 'POST',
