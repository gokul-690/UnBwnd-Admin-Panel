...
export default function UserManagement() {
  ...
  const fetchUsers = async (silent = false) => {
    ...
    try {
      const res = await fetch('https://unbwnd-backned1.onrender.com/api/admin/users', { cache: 'no-store' });
    ...
    <div className="space-y-6">
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      await fetch(`https://unbwnd-backned1.onrender.com/api/admin/users/${editingUser.id}`, {
      ...
      <ConfirmModal
        ...
        onConfirm={async () => {
          ...
          setIsLoading(true);
          try {
            await fetch(`https://unbwnd-backned1.onrender.com/api/admin/users/${id}`, { method: 'DELETE' });
            fetchUsers();
          } catch (e) { 
            console.error(e); 
            setIsLoading(false);
